...
impl AttackValidator for AttackCooldown {
    fn validate(&self, args: &ThinkerProcessArgs, _attack: &AttackData, attack_id: &usize) -> bool {
        let query = FactQuery::with_check(FactQueryCheck::Match(WMProperty::Event(Event::AttackPerformed {id: *attack_id})));
...
impl AttackValidator for AttackVisibleWithinRange {
    fn validate(&self, args: &ThinkerProcessArgs, _attack: &AttackData, _attack_id: &usize) -> bool {
...
impl AttackValidator for AttackWorldStateRequirement {
    fn validate(&self, args: &ThinkerProcessArgs, _attack: &AttackData, _attack_id: &usize) -> bool {
        self.required_world_state.count_state_differences(args.world_state) == 0
    }
}
